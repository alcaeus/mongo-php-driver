...
/* {{{ proto MongoDB\Driver\ClientEncryption MongoDB\Driver\Manager::clientEncryption()
   Return a ClientEncryption instance */
static PHP_METHOD(Manager, clientEncryption)
{
	php_phongo_manager_t*          intern;
...
ZEND_BEGIN_ARG_INFO_EX(ai_Manager_clientEncryption, 0, 0, 1)
...
static zend_function_entry php_phongo_manager_me[] = {
	...
	PHP_ME(Manager, clientEncryption, ai_Manager_clientEncryption, ZEND_ACC_PUBLIC | ZEND_ACC_FINAL)
